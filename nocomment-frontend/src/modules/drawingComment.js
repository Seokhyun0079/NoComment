...
const [
    ...
    INSERT_SUCCESS,
    INSERT_FAILURE
] = createRequestActionTypes('drawingComment/INSERT');

export const initialize = createAction(INITIALIZE);
export const insert = createAction(INSERT, ( formData ) => (
    formData
));

const drawingCommentInsertSaga = createRequestSaga(INSERT, drawingCommentApi.insertDrawingComment);
